...
// in baker_soft_shop/test/core/shared_preferences/shared_preferences_test.dart.
...
/// A class which mocks [SharedPreferencesAbstract].
///
/// See the documentation for Mockito's code generation for more information.
class MockSharedPreferencesAbstract extends _i1.Mock
    implements _i2.SharedPreferencesAbstract {
  MockSharedPreferencesAbstract() {
  ...
  @override
  _i3.Future<bool> removeAllExcept(List<String>? keys) => (super.noSuchMethod(
        Invocation.method(
          #removeAllExcept,
          [keys],
        ),
